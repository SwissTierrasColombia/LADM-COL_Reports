...
predios_seleccionados AS (
    SELECT col_uebaunit.baunit as t_id FROM ladm_lev_cat_v1.col_uebaunit WHERE col_uebaunit.ue_lc_terreno = 1432 -- parametrizar nombre schema, tablas, atributos y WHERE
),
